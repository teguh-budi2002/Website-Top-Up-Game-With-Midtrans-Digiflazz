                ...
                <div class="grid sm:grid-cols-3 grid-cols-1 gap-3">
                    <div class="md:w-3/4 w-full flex flex-col items-start justify-between space-y-10">
                        ...
                        <div class="social_media flex items-center space-x-5">
                            <a href="{{ app('social_media')->instagram }}" target="_blank">
                            ...
                            <a href="{{ app('social_media')->facebook }}" target="_blank">
                            ...
                            <a href="mailto::{{ app('social_media')->email }}" target="_blank">
                            ...
                            <a href="https://wa.me/{{ app('social_media')->whatsapp }}" target="_blank">
                                <i class="fa-brands fa-whatsapp fa-xl dark:text-green-400 text-green-800 hover:text-green-500 transition-colors duration-150"></i>
                            </a>
                        </div>
                        <div class="copyright">
...
@stack('js-custom')
<script>
if("true"===localStorage.getItem("darkmode")){let e=document.documentElement;window.onpaint=e.classList.add("dark")}else localStorage.setItem("darkmode",!1);window.addEventListener("load",(function(){const e=document.querySelector(".loading");e&&e.classList.add("hidden")}));
</script>
</body>
</html>
