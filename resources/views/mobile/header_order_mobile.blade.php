<div class="mobile__display__header md:hidden block md:mx-0 mx-3 mb-10">
    <div>
        <div class="top_section md:mt-0 mt-32 border-0 border-b border-solid dark:border-slate-500 border-violet-500 pb-4">
            ...
            @endif
            <p class="mt-5 font-bold text-md dark:text-slate-50 text-violet-800">Top Up {{ $product->product_name }}</p>
        </div>
        <div class="badge mt-5">
            <div class="flex items-center space-x-3">
                <div
                    class="badge_support flex items-center space-x-2 bg-violet-500 hover:bg-violet-400 dark:bg-slate-400 dark:hover:bg-white rounded-lg p-1 px-2 w-fit text-[10px] transition-colors duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-4 h-4 text-slate-50 dark:text-slate-600">
                ...
                <div
                    class="badge_fast_transaction flex items-center space-x-2 bg-violet-500 hover:bg-violet-400 dark:bg-slate-400 dark:hover:bg-white rounded-lg p-1 px-2 w-fit text-[10px] transition-colors duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-4 h-4 text-slate-50 dark:text-slate-600">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    class="badge_secure_transaction flex items-center space-x-2 bg-violet-500 hover:bg-violet-400 dark:bg-slate-400 dark:hover:bg-white rounded-lg p-1 px-2 w-fit text-[10px] transition-colors duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-4 h-4 text-slate-50 dark:text-slate-600">
                        <path stroke-linecap="round" stroke-linejoin="round"
