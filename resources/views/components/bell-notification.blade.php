...
<div x-data="{ 
    ...
    <div class="notif__bell relative z-[999]"
        @click="isHiddenNotifDot = true; localStorage.setItem('NOTIF_DOT', isHiddenNotifDot.toString()); isNotifOpen = true">
        ...
        <div class="notif__dropdown absolute top-14 -left-96 bg-white w-[430px] h-auto p-1 rounded-md z-50"
            x-show="isNotifOpen" x-transition.duration.400ms>
            ...
            <a href="#" @click="alertNotif = true; localStorage.setItem('ALERT_NOTIF', alertNotif.toString())"
                ...
                <div class="space-y-1.5">
                    <p class="uppercase text-slate-800 group-hover:text-white font-extrabold">DISKON ANJAI</p>
                ...
                <div class="alert_notif">
                    <div class="w-4 h-4 rounded-full bg-red-500 animate-pulse" :class="{'invisible' : alertNotif}">
                    </div>
                </div>
            </a>
