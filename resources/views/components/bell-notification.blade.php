...
<div x-data="handleNotification()">
    ...
    <div class="triangle__notif__bell" x-show="isBellNotifOpen" x-transition:enter.delay.130ms
    ...
    <div class="notif__dropdown absolute md:top-24 top-20 right-1 bg-white md:w-[480px] w-11/12 p-1 rounded-lg z-[9999] no-scrollbar"
        :class="isLoading ? 'h-[140px]' : 'h-[300px] min-h-max overflow-y-scroll'" x-show="isBellNotifOpen"
            ...
            <div class="body__notif">
                <template x-for="notif in notifications" :key="notif.id">
                    <div x-cloak x-show="!isLoading"
                        @click.prevent="alertNotif = true; handleNotifRead(notif.id); isNotifPopupOrRedirect(notif.type_notif, notif.id, notif.notif_slug)"
        ...
        <div class="load__more text-center">
            <button x-show="!isLoading && hasMorePages" @click="getNotifications()"
