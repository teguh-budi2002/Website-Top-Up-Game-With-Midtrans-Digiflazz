<div x-show="isOpen" x-cloak @keydown.window.prevent.esc="isOpen = false" x-transition:enter="transition duration-300"
    ...
    <div class="bg-white dark:bg-primary-slate relative md:top-28 top-28 mx-auto md:w-4/12 w-10/12 cursor-pointer rounded-t-md p-5" @click.window.prevent.away="isOpen = false">
        ...
        <div
            ...
            <div class="text-primary-cyan flex items-center space-x-1 text-xs">
                ...
                <span class="transition-colors dark:hover:text-cyan-300">to close</span>
            </div>
        </div>
    </div>
</div>
