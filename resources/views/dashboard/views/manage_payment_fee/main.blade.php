  ...
  <main class="w-full h-full">
    ...
    <div class="box__container mt-5">
        <div class="">
            ...
            <div class="w-10/12 h-auto p-3 bg-white dark:bg-primary shadow-md rounded mx-auto mt-5" x-data="handlePaymentFee">
                <form action="{{ URL('/dashboard/add-payment-fee') }}" method="POST">
                  @csrf
                  <div class="all__payments space-y-2">
                    <label for="payment_methods" class="block">All Payment</label>
                  ...
                  <div class="type__fee text-xs flex items-center space-x-3 mt-4">
                    ...
                    <div class="is_fix_fee">
                      <label for="is_fix_fee">Fix Fee</label>
