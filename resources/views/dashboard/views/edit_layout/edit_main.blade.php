    ...
    <div class="w-3/4 bg-white rounded p-5 mx-auto mt-10 mb-20">
        <div>
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1"  x-data="addInput()">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-600">
                        ...
                        <form action="{{ URL("dashboard/layout/nav/edit") }}" method="POST" class="mt-3">
                            ...
                            <p x-text="inputFields"></p>
                            <div class="flex items-center justify-between gap-4 mt-3">
                                <button class="py-2.5 px-6 rounded bg-primary text-white">Edit Layout</button>
                                  <div class="button__add__input">
                                    <button @click.prevent="handleAddInput(event)" type="button" class="bg-green-400 text-white p-2 flex items-center">
            ...
            <div id="accordion-collapse-heading-2">
                <button type="button"
                    ...
                    <span class="text-gray-500 dark:text-gray-400 dark:hover:text-white transition">Text Head Navigation</span>
            ...
            <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-600">
                    <p class="mb-2 text-gray-500 dark:text-gray-200">Example</p>
                    <img src="{{ asset("/img/ExampleLayout/TextHeaderNavigation.webp") }}" class="w-auto h-20
            rounded-md" alt="Contoh Text Head Nav">
            <form action="{{ URL("dashboard/layout/nav/edit") }}" method="POST" class="mt-3">
                @csrf
                <div class="form_group">
                    <x-form.input type="text" inputName="text_head_nav" name="text_head_nav"
