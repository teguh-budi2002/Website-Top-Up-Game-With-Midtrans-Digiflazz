    ...
    <form action="{{ URL('dashboard/add-payment-method') }}" method="POST">
        ...
        <div class="payment_methods">
            ...
            <div x-data="multiselect()" x-init="loadOptions()"
                class="w-auto h-auto">
                <input name="payment_method_ids[]" type="hidden" :value="selectedValues()">
                <div class="inline-block relative w-64 h-fit">
                            ...
                            <div class="my-2 p-1 flex border border-gray-200 bg-white rounded">
                                <div class="flex flex-auto flex-wrap">
                                    <template x-for="(option,index) in selected" :key="options[option].value">
                                        <div
                                            class="flex justify-center items-center m-1 font-medium py-1 px-1 bg-white text-black rounded border">
	...
	" />
                        ...
                        <div class="w-full px-4">
                            <div x-show="isOpen()" x-transition
                                class="absolute shadow bg-white z-40 w-full left-0 rounded h-fit"
                                x-on:click.away="close">
                                <div class="flex flex-col w-full overflow-y-auto h-fit text-black">
        ...
        <div class="btn mt-3">
          <button type="submit" class="py-2.5 px-8 rounded bg-primary dark:bg-primary-dark text-white">Add Payment</button>
        </div>
    </form>
</div>
