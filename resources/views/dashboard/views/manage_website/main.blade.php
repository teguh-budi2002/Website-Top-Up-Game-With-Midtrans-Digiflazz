    ...
    <div class="w-full h-full mx-3">
        <div class="w-full h-full flex justify-center">
            <div class="grid grid-cols-2 gap-5">
                <div class="w-[600px] rounded bg-white shadow-md p-4 mt-5 mb-24">
                    <div class="manage_page">
                        @include('dashboard.views.manage_website.custom_page')
                    </div>
                </div>
                <div class="w-full h-fit rounded bg-white shadow-md p-4 mt-5">
                    <div class="list_page">
                                ...
                                <tbody class="text-sm text-primary dark:text-primary-light divide-y divide-primary-100">
                                    ...
                                    <tr id="{{ $product->id }}">
                                        ...
                                        <td class="p-2 flex justify-start">
                                            <a href="?slug={{ $product->slug }}" class="block p-1 bg-primary-100 rounded hover:bg-primary hover:text-white transition-colors duration-150">
