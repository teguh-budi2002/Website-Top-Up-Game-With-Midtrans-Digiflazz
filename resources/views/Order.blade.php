<x-app-layout>
    ...
    <div class="w-full h-full overflow-x-hidden">
        ...
        <img src="{{ asset('/storage/' . $custom_field->bg_img_on_order_page) }}"
            class="custom__bg__img w-full md:h-[700px] h-[300px] object-cover bg-no-repeat bg-top -z-10 absolute top-24"
        ...
        @endif
        <div class="container__shadaow w-full h-full overflow-x-hidden z-50">
            <section class="content w-full h-full md:mx-10 mx-0">
                @include('mobile.header_order_mobile')
                <div class="wrapper_grid md:block hidden">
      ...
      @include('mobile.form_order_mobile')
    </div>
    @push('js-custom')
    <script>
