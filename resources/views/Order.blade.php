...
<div class="w-full h-full overflow-x-hidden bg-gradient-to-r from-violet-50 via-violet-100 to-violet-100 dark:bg-gradient-to-r dark:from-[#0F0F0F] dark:to-[#0F0F0F]" x-data="handleOrder()">
    ...
    <img src="https://source.unsplash.com/random/1920x800"
        ...
        alt="random_img">
    @endif
    <div class="bg-gradient-to-b from-transparent via-violet-300 to-violet-100 dark:bg-gradient-to-b dark:from-transparent dark:via-[#1D1B1B] dark:to-[#0F0F0F] bg-cover w-full md:h-[900px] h-[400px] absolute overflow-x-hidden z-20"></div>
...
@push('js-custom')
<script>
function handleOrder(){return{accessApiToken:"{{ $token }}",data:{player_id:"",product_id:"",code_game:"",zone_id:"",itemSelected:"",itemNominal:"",number_phone:"",qty:1},fee_flat:0,fee_fixed:0,feeType:"",initialPrice:0,priceIncludeFee:0,selectedPaymentId:"",activeItem:null,paymentSelected:"",isDisablePaymentMethod:!1,showBestDealBanner:!1,isButtonSubmitDisabled:!1,errMess:{},showInvalidUserIDModal:!1,errMessTooManyAttemptReq:"",init(){this.data.product_id="{{ $product->id }}",this.data.code_game="{{ $product->code_product }}"},selectedItemProduct(){this.handlePaymentFee(),this.priceIncludeFee=this.formatPriceToRupiah(this.priceIncludeFee)},selectedPayment(){this.handlePaymentFee(),this.priceIncludeFee=this.formatPriceToRupiah(this.priceIncludeFee)},checkingValidationForm(){this.isButtonSubmitDisabled=!0,this.errMessTooManyAttemptReq="";let e={code_game:this.data.code_game,player_id:this.data.player_id,zone_id:this.data.zone_id};axios.post("/api/validation-id",e,{headers:{"X-Custom-Token":this.accessApiToken}}).then((e=>{200==e.data.code&&e.data.data.IS_USER_VALID&&(this.checkoutOrder(),this.isButtonSubmitDisabled=!1),400==e.data.code&&(this.showInvalidUserIDModal=!0,this.isButtonSubmitDisabled=!1),429==e.data.code&&(this.errMessTooManyAttemptReq=e.data.message,this.showInvalidUserIDModal=!0,this.isButtonSubmitDisabled=!1)})).catch((e=>{console.log("ERROR SERVERSIDE VALIDATION USER-ID"),this.isButtonSubmitDisabled=!1}))},checkoutOrder(){let e={player_id:this.data.player_id,zone_id:this.data.zone_id,product_id:this.data.product_id,item_id:this.activeItem,payment_id:this.handleDisblePaymentMethod()?"":this.selectedPaymentId,number_phone:this.data.number_phone,price:this.convertPriceIntoInteger(),before_amount:this.initialPrice,qty:this.data.qty};axios.post("/api/order/{{ $product->slug }}",e,{headers:{"X-Custom-Token":this.accessApiToken}}).then((e=>{if(201==e.data.code){const t=e.data.data;window.location.replace(`/checkout/${t}`)}})).catch((e=>{if(500==e.response.status&&console.log(e.response.data.message),422==e.response.status){const t=e.response.data.errors;this.errMess={errorPlayerId:t.player_id,errorItem:t.price,errorPaymentId:t.payment_id,errorNumberPhone:t.number_phone}}}))},handlePaymentFee(){const e=this.initialPrice;if("fee_fixed"===this.feeType){let t=.01*this.fee_fixed*e+e;this.priceIncludeFee=500*Math.ceil(t/500)}else if("fee_flat"===this.feeType){let t=parseInt(this.fee_flat)+e;this.priceIncludeFee=t}},formatPriceToRupiah:e=>e.toLocaleString("id-ID",{style:"currency",currency:"IDR"}),convertPriceIntoInteger(){const e=this.priceIncludeFee,t=e?e.replace(/[^0-9]/g,""):null;return parseInt(t)/100},handleDisblePaymentMethod(){let e=this.initialPrice,t=this.feeType;return e<25e3&&"fee_flat"===t}}}    
</script>
@endpush
</x-app-layout>
