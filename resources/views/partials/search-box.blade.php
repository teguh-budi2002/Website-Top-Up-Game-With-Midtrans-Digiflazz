        ...
        <x-modal>
            ...
            <div x-show="isLoading" class="mt-4 mb-2">
                <div class="text-center">
                    <div role="status">
                        <svg aria-hidden="true" class="inline w-8 h-8 mr-2 text-gray-200 animate-spin fill-primary-cyan-light" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
